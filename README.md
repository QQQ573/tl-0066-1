...
- **第 1 关 (新手训练日)**: 2 个系列（Labubu + Dimoo），30% 干扰率，无隐藏款；2 次催单（第4批 Labubu ×2，第8批 Dimoo ×2），30秒时限
- **第 2 关 (繁忙周末)**: 3 个系列（Labubu + Dimoo + Molly），50% 干扰率，传送带提速；3 次催单（第3/6/9批各系列 ×2），25秒时限
- **第 3 关 (隐藏款警戒)**: 5 个系列（含隐藏款），60% 干扰率，隐藏款必须放入隔离槽；3 次催单（第3/6/9批各常规系列 ×2），20秒时限，催单不涉及隐藏款
